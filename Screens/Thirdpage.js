      ...
      <View style={{ margin: '10%', }}>
        ...
        <View style={{ marginTop: '20%' }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
            <TouchableOpacity style={{ borderColor: '#4A89DC', borderWidth: 2, borderRadius: 5, height: '70%',
             width: '45%', alignItems: 'center', justifyContent: 'flex-end' }} onPress={()=>navigation.navigate('OtpScreen')} >
